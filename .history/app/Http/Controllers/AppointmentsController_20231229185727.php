...
class AppointmentsController extends Controller
{
    ...
    public function singleAppointment($id)
    {
        ...
        return Inertia::render('Appointments/SingleAppointment', ['appointment' => $appointment]);
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            $appointment = $this->appointmentService->createAppointment($userId, $request->service_id, $request->appointment_date, $request->appointment_time, $request->staff_id, $request->use_points);
