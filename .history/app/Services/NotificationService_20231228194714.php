...
class NotificationService
{
    ...
    public $messagesList = [
        ...
        'appointmentsUsedPoints' => '+%s points have been deducted from your card after you used them for your appointment'
    ];
    ...
    protected function formatMessage($key)
    {
        if (array_key_exists($key, $this->messagesList)) {
            ...
            if (strpos($message, ':date') !== false && isset($this->userName)) {
