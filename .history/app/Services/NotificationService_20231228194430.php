...
class NotificationService
{
    ...
    public $messagesList = [
        ...
        'appointments' => 'Your application for a meeting on :data at :time has been accepted. The service is :service',
     ...
     * Set the user ID for the notification.
     *
     * @param string $date User ID for the notification.
     */
     ...
     * Set the user ID for the notification.
     *
     * @param string $time User ID for the notification.
     */
     ...
     * Set the user ID for the notification.
     *
     * @param string $service User ID for the notification.
     */
    public function setService($time)
    {
        $this->time = $time;
    }
    ...
    protected function formatMessage($key)
    {
        if (array_key_exists($key, $this->messagesList)) {
            ...
            if (strpos($message, ':data') !== false && isset($this->userName)) {
                $message = str_replace(':data', $this->userName, $message);
            }
