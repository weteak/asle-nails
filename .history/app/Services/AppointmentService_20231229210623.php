...
class AppointmentService
{
    ...
    public function updateAppointment($appointmentId, $serviceId, $date, $time, $use_points)
    {
        ...
        if ($appointment) {
            ...
            $this->notificationService->setDate($date);
            $this->notificationService->setSlug($appointment->id);
            $this->notificationService->setTime($time);
            $this->notificationService->trigger('appointmentUpdated');
        }
