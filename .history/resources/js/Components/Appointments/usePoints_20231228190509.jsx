            ...
            <motion.div initial={{ opacity: 0, y: '4%' }}
                ...
                <div className="mt-3 text-center">
                    ...
                    <div className="items-center px-4 py-3">
                        ...
                        <button id="cancel-btn" className="px-4 py-2 mt-3 underline bg-white text-indigo-500 text-base font-medium rounded-md w-full  hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-indigo-900" onClick={()=>}>
                            No, maybe later
                        </button>
                    </div>
                </div>
