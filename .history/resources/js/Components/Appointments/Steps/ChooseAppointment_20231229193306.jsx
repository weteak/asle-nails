...
export default function ChooseAppointments({ edit = false, selDate = new Date(), selTime = '', user, serviceSelected, staffSelected }) {

    const [selectedDate, setSelectedDate] = useState(selDate);
    const [selectedTime, setSelectedTime] = useState(se);
