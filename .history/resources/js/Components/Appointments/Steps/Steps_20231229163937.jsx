...
export default function Steps({ services, user, staff }) {
    ...
    return <div>
        <span className="absolute   left-4 -mt-2 bg-blue-200"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-arrow-left" viewBox="0 0 16 16">
