...
export default function Steps({ services, user, staff }) {
    ...
    return <div>
        <div className='w-full flex gap-2'>
            ...
            <h1 className='text-xl whitespace-nowrap bg-blue-500 bg-opacity-5  my-auto  w-fit py-2 px-4 rounded-md font-bold'>{currentStep == 0 ? <span> Choose <span className='text-blue-600'>Service</span></span> : currentStep == 'Appointment'} </h1>
            <span className='h-[1px] my-auto bg-black bg-opacity-30 w-full'></span>
        </div>
