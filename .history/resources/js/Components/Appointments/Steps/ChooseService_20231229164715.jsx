    ...
    return <div className="mt-4">
        <div className="flex flex-col mt-2 ">
            {services.map((val, key) => {
                ...
                return <div key={`service-${key}`} className="w-full border-b px-2.5 py-4 border-opacity-10  relative
                 border-slate-600  flex gap-2  ">
                    ...
                    <span onClick={() => { setStep(1); setServiceSelected(val) }} className="absolute top-1/2 -translate-y-1/2 right-6">
