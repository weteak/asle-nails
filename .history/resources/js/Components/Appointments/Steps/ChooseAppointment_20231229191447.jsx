...
export default function ChooseAppointments({ edit = false, user, serviceSelected, staffSelected }) {
    ...
    return <> <form onSubmit={handleSubmit} className="space-y-4 px-5 mt-6">
        <div>
            ...
            <div className={`sticky  ${edit ? 'top-12':'top-16'} top-16 pt-4 w-full  bg-white py-2  flex gap-1 `}>
