...
export default function ChooseAppointments({ user, serviceSelected, staffSelected }) {
    ...
    useEffect(()=>{
        const transferCredit = async (creditInfo) => {
            try {
                const response = await axios.post('/api/transfer-credit', creditInfo);
                console.log('Credit transferred successfully:', response.data);
            } catch (error) {
