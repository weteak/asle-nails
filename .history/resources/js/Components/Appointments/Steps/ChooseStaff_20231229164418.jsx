    ...
    return <div className="mt-4">
        <div className="flex flex-col mt-2 ">
            {staff.map((val, key) => {
                ...
                return <div onClick={() => { setStep(2); setStaffSelected(val) }} key={`staff-${key}`} className="w-full border-b py-4 border-opacity-10  relative
                 border-slate-600 hover:bg-gray-100 animation-all duration-150  flex gap-2  ">
                    <img
                        loading="lazy"
