...
export default function ChooseStaff({ staff, staffSelected, setStaffSelected }) {
            ...
            {staff.map((val, key) => {
                ...
                return <div key={`staff-${key}`} className="w-full border-b py-4 border-opacity-10  relative
                 border-slate-600  flex gap-2  ">
                    ...
                    <span onClick={() => { setStep(1); set(val) }} className="absolute top-1/2 -translate-y-1/2 right-2">
