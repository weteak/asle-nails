        ...
        <div className="w-full flex flex-col gap-2">
            {loading ? divArray.map((item, index) => (
                ...
                <button
                    ...
                    className={`w-full p-2 border rounded-md ${timeSlot.hour === selectedTime ? 'border-blue-500 text-blue-600 bg-blue-600 bg-opacity-10 font-bold' : 'border-gray-300'} ${busyTimes.includes(timeSlot.hour) ? 'bg-gray-400 bg-opacity-20 text-gray-500 cursor-not-allowed' : ''}`}
