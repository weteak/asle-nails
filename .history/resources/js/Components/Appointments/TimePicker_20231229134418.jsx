...
export default function TimePicker({ busyTimes, setSelectedTime, selectedTime, staffId, selectedDate }) {
    ...
    const generateTimeSlots = () => {
        ...
        for (const [hour, count] of Object.entries(times)) {
            let formattedHour = `${parseInt(hour).toString().padStart(2, '0')}:00 ${parseInt(hour) < 12 ? 'am' : 'pm'}`;
