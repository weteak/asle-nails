    ...
    return openTransfer !== null && (
        <>
            ...
            <motion.form onSubmit={transfer} initial={{ opacity: 0, y: '4%' }}
                ...
                exit={{ opacity: 0, y: '4%' }}
                transition={{ duration: 0.3, ease: 'easeInOut' }} className='fixed left-2 border border-slate-500 border-opacity-50 shadow-xl rounded-lg right-4 top-[20%] -translate-y-1/2 z-40 bg-white'>
