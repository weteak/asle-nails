                        ...
                        <AnimatePresence>
                            {showingNavigationDropdown && <>
                                ...
                                <motion.div initial={{ opacity: 0, x: '20%' }}
                                    ...
                                    className='h-fit -translate-x-1/2 top-1/2 left-1/4 fixed w-fit  flex flex-col shadow-md   z-50  border-l right-0 border-slate-400 border-opacity-20 bg-white'>
