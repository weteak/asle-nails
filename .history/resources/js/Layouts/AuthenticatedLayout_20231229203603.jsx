                             ...
                             border-opacity-20 ${grid}`}>
                                ...
                                {user.role === 'user' &&
                                    <div className={`relative hover:bg-blue-500 group hover:bg-opacity-10 hover:text-blue-500 animation-all duration-200  mx-auto rounded-full p-3 w-fit `}>
                                        {user.notification_unread > 0 && <span className='absolute group-hover:bg-transparent  p-1 right-4 z-40 bg-white top-0 font-bold text-blue-600  '>+{user.notification_unread}</span>
                                        }
