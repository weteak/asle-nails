                             ...
                             border-opacity-20 ${grid}`}>
                                ...
                                {user.role === 'user' &&
                                    <div className={`relative hover:bg-blue-500 group hover:bg-opacity-10 hover:text-blue-500 animation-all duration-200  mx-auto rounded-full p-3 w-fit `}>
                                        {user.notification_unread > 0 && <span className='absolute group-hover:bg-transparent  p-1 right-1 z-40 bg-white top-0 font-bold text-blue-600  rounded-full'>+{user.notification_unread}</span>
                                        }
                        ...
                        <AnimatePresence>
                            {showingNavigationDropdown &&
                                ...
                                <motion.div initial={{ opacity: 0, y: '10%' }}
                                    ...
                                    className='w-fit h-fit  flex flex-col shadow-md  rounded-lg fixed top-20 z-50  border right-5 border-slate-500 border-opacity-20 bg-white'>
