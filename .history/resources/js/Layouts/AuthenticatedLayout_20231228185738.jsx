                            ...
                            <div className={`pt-2 pb-2  w-full md:hidden  items-center border-b border-slate-500
                             border-opacity-20 ${grid}`}>
                                {dataMobile.map((val, key) => {
                                    return <div key={`menu-${key}`} className={`${route().current(val.route) && 'bg-blue-600 bg-opacity-10 text-blue-600'} hover:bg-blue-500 hover:bg-opacity-10 hover:text-blue mx-auto rounded-full p-3 my-auto w-fit `}>
