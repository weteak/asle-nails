...
const AppointmentItem = ({ appointment }) => (
    <div className="p-4 relative border-b flex items-center">
        ...
        <div className="flex flex-col ml-4">
            ...
            <span className="text-sm border border-blue-400 border-opacity-60 bg-blue-500 flex mt-1.5 gap-1 bg-opacity-5 py-0.5 text-blue-700 w-fit px-2 rounded-md bg">
