    ...
    return (
        <div className="flex items-center justify-center p-6 m-4 rounded-lg shadow-lg bg-white border border-gray-200">
            <div className="text-center">
                ...
                <p className="text-gray-600 bg-indigo-500 mb-6">Unlock exclusive features and rewards by subscribing to the Asle Card. Join now to enhance your experience!</p>
             <div>Subscribe to our card, which is provided directly from our physical store.</div>
            </div>
        </div>
    );
};
