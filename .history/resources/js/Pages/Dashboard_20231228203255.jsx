...
export default function Dashboard({ auth, appointments }) {
    ...
    return (
        <AuthenticatedLayout user={auth.user}>
            ...
            <h1 className='text-xl whitespace-nowrap bg-blue-500 bg-opacity-5  my-auto  w-fit py-2 px-4 rounded-md font-bold'> Your <span className='text-blue-500'>Appointments</span>  </h1>
            <span className='h-[1px] my-auto bg-black bg-opacity-30 w-full'></span>
