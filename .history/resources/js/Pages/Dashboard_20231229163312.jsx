...
const AppointmentItem = ({ appointment }) => (
    <div className="p-4 relative border-b flex items-center">
        ...
        <div className="flex flex-col ml-4">
            ...
            <span className="text-sm bg-blue-500 flex gap-1 bg-opacity-5 py-0.5 text-blue-700 w-fit px-2 rounded-md bg">
            ...
            <span className='text-xs mt-2 '>With {appointment.staff.name}</span>
        </div>
        <div className="ml-auto top-1/2 flex text-right flex-col absolute right-5">
