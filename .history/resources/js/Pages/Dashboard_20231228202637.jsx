                    ...
                    <div className="mt-2 space-y-4">
                        {appointments.length > 0 &&
                            appointments.map((val, key) => (
                                <div key={`val-${key}`} className="p-4 relative rounded-lg border flex items-center">
                                    ...
                                    <div className="ml-auto flex flex-col absolute right-4">
                                        <span className="text-sm">{formatDate(val.appointment_date)}</span>
                                        <span className="text-sm bg-blue-500 bg-opacity-10 w-fit mx-auto px-2 py-1 text-right">{formatTime(val.appointment_time)}</span>
                                    </div>
                                </div>
                            ))}
                    </div>
