...
const AppointmentItem = ({ appointment }) => (
    <div className="p-4 relative border-b flex items-center">
        ...
        <div className="flex flex-col ml-4">
            ...
            <span className="text-sm bg-blue-500 bg-opacity-10 text-blue-700 w-fit px-2 rounded-md bg">{appointment.service.duration} min</span>
            <span className='text-xs mt-3 '>With {appointment.staff.name}</span>
        </div>
