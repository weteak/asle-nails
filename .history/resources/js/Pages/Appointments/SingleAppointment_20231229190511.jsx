    ...
    return <div>
        ...
        <div className="mt-4">
            ...
            <div className="px-6 my-4 border-y py-8 ">
                ...
                <button className="w-full border  border-blue-600 border-opacity-80 bg-gray-300 bg-opacity-10 hover:bg-opacity-20 text-blue-600 font-bold py-3.5 px-4 rounded-md">Cancel Appointment</button>
            </div>
