        ...
        <div className="mt-4">
            <div className="px-6 py-5 relative border-b flex items-center">
                ...
                <div className="flex my-auto flex-col ml-4">
                    ...
                    <span className="text-xs  bg-blue-500 flex mt-1.5 gap-1 bg-opacity-5 py-1 text-blue-700 bg-blue-400 w-fit px-2 rounded-md bg">
                ...
                <div className="s bg-white">
                    <div className="p-6">
                        <div className="flex items-center justify-between">
                            ...
                            <button onClick={() => callPhoneNumber(appointment.staff.phone_number)} className="flex absolute right-2 bg-opacity-10 text-blue-600 items-right justify-right   font-semibold py-2 px-4 rounded-lg ">
                                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" className="bi bi-telephone mr-2" viewBox="0 0 16 16">
