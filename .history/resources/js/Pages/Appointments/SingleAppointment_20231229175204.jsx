    ...
    return <div>
        ...
        <div className="m-4">
            ...
            <div className="w-full flex gap-2 relative border-y py-4 mt-2">
                <img className="w-32 mx-4 my-auto object-cover rounded-full  h-32" src={returnImage(imagePathFormat(appointment.staff.profile_image))} alt={`${appointment.staff.profile_image}`} />
