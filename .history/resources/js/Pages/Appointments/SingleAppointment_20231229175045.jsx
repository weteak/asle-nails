        ...
        <div className="m-4">
            ...
            <div className="w-full flex gap-2 relative border-y py-4 mt-2">
                ...
                <div className="absolute right-4 text-right">
                    ...
                    <span>+355{appointment.staff.phone_number}</span>
                    <span><svg xmlns="http://www.w3.org/2000/svg" width="32" height="24" fill="currentColor" className="bi bi-telephone" viewBox="0 0 16 16">
