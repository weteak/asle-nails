...
const formatTime = (time) => {
    ...
    return new Date(`1970-01-01T${time}`).toLocaleTimeString('de-DE', options);
     ...
     return <div>
        ...
        <img className="w-32 object-cover rounded-full mt-5 h-40" src={returnImage(imagePathFormat(appointment.staff.profile_image))} alt={`${appointment.staff.profile_image}`}/>
        </div>
        </div>
     </div>
}