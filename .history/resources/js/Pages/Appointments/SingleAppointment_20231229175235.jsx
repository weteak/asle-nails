...
export default function SingleAppointment({ auth, appointment }) {
    ...
    return <div>
        ...
        <div className="mt-4">
            <div className="px-6 relative border-b flex items-center">
            ...
            <div className="w-full flex gap-2 relative border-y py-4 mt-2">
                <img className="w-32 mx-5 my-auto object-cover rounded-full  h-32" src={returnImage(imagePathFormat(appointment.staff.profile_image))} alt={`${appointment.staff.profile_image}`} />
