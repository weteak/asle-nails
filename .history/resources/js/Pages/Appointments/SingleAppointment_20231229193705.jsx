...
export default function SingleAppointment({ appointment , user }) {
    ...
    return <div>
        ...
        {openEdit ? <ChooseAppointments edit={true} selTime={formatTimeappointment.appointment_time} user={user} serviceSelected={appointment.service.id} staffSelected={appointment.staff}/> :
        <div className="mt-4">
