    ...
    return <div>
        ...
        <div className="mt-4">
            ...
            <div className="px-6 my-4 border-y py-8 ">
                <button onClick={()=>setOpenEdit(TR)} className="w-full mb-2 py-3.5 bg-blue-600 hover:bg-opacity-80 bg-opacity-90 text-white font-bold  px-4 rounded-md">Edit Appointment</button>
