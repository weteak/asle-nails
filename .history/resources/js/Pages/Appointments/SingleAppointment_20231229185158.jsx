                ...
                <div className="s bg-white">
                    <div className="p-6">
                        <div className="flex items-center justify-between">
                            ...
                            <button onClick={() => callPhoneNumber(appointment.staff.phone_number)} className="flex absolute right-1 bg-opacity-10 text-blue-600 items-right justify-right   font-semibold py-2 px-4 rounded-lg ">
