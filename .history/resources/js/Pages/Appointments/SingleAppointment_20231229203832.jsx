...
export default function SingleAppointment({ appointment, user }) {
    ...
    function callPhoneNumber(phoneNumber) {
        window.location.href = `tel:+355${phoneNumber}`;
    }
    ...
    let selectedDate = moment(convertToFormattedDate(appointment.appointment_date)); 
    ...
    return <div>
        ...
        {openEdit ? <ChooseAppointments appointment={appointment} edit={true} selDate={dateObject} selTime={formatTime(appointment.appointment_time)} user={user} serviceSelected={appointment.service} staffSelected={appointment.staff} /> :
            <div className="mt-4">
