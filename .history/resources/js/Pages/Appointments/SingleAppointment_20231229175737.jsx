    ...
    return <div>
        ...
        <div className="mt-4">
            ...
            <div className=" px-7 flex flex-col gap-1 text-left">
                    ...
                    <div className="mt-4 flex gap-2 "> Call it<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-telephone" viewBox="0 0 16 16">
