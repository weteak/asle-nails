...
export default function SingleAppointment({ appointment }) {
    ...
    return <div>
        ...
        {openEdit ? <ChooseAppointments user={auth.user} serviceSelected={appointment.service.id} staffSelected={appointment.staff.id}/> :
        <div className="mt-4">
