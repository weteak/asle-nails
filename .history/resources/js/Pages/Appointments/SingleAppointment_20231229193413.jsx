...
export default function SingleAppointment({ appointment , user }) {
    ...
    return <div>
        ...
        {openEdit ? <ChooseAppointments edit={true} selDate={appointment.appointment_date} user={user} serviceSelected={appointment.service.id} staffSelected={appointment.staff}/> :
        <div className="mt-4">
