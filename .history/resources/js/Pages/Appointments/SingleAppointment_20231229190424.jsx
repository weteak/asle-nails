    ...
    return <div>
        ...
        <div className="mt-4">
            ...
            <div className="px-6 my-4 border-y py-8 ">
                ...
                <button className="w-full border  border-slate-600 border-opacity-80 bg-gray-500 bg-opacity-10 hover:bg-opacity-20 text-slate-800 font-bold py-3.5 px-4 rounded-md">Cancel Appointment</button>
            </div>
