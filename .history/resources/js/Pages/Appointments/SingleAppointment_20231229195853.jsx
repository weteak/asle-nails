...
export default function SingleAppointment({ appointment, user }) {
    ...
    let selectedDate = moment(convertToFormattedDate(appointment.appointment_date)); // moment object
    ...
    return <div>
        ...
        {openEdit ? <ChooseAppointments edit={true} selDate={convertToFormattedDate(appointment.appointment_date)} selTime={formatTime(appointment.appointment_time)} user={user} serviceSelected={appointment.service.id} staffSelected={appointment.staff} /> :
            <div className="mt-4">
