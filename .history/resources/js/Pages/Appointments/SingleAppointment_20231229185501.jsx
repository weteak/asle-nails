                ...
                <div className="s bg-white">
                    <div className="p-6">
                        <div className="flex items-center justify-between">
                            ...
                            <button onClick={() => callPhoneNumber(appointment.staff.phone_number)} className="flex absolute right-5 bg-blue-500 bg-opacity-5 text-blue-600 text-opacity-50 items-right justify-right   font-semibold p-4 rounded-full  ">
