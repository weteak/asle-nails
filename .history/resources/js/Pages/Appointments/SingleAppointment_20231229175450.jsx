    ...
    return <div>
        ...
        <div className="mt-4">
            ...
            <div className=" px-7 text-left">
                ...
                <img className="w-20 absolute top-1/2 -translate-y-1/2 right-2 mx-2 my-auto object-cover rounded-full  h-24" src={returnImage(imagePathFormat(appointment.staff.profile_image))} alt={`${appointment.staff.profile_image}`} />
