...
export default function SingleAppointment({ auth, appointment }) {
    ...
    return <div>
        ...
        <div className="mt-4">
            ...
            <div className="container mx-auto  border-y py-3 my-3">
                <div className="s bg-white">
                    ...
                    <div className="px-6 py-4 bg-gray-50 rounded-b-xl">
                        <button className="w-full mb-2 bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg">Edit Appointment</button>
                        <button className="w-full bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-4 rounded-lg">Cancel Appointment</button>
                    </div>
                </div>
            </div>
