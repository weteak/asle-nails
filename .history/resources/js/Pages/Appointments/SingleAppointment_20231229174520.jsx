...
const formatTime = (time) => {
    ...
    return new Date(`1970-01-01T${time}`).toLocaleTimeString('de-DE', options);
     ...
     return <div>
        ...
        <img className="w-1/2 object-cover rounded-md mt-5 h-40" src={returnImage(imagePathFormat(appointment.staff.profile_image))} alt={`${appointment.staff.profile_image}`}/>
