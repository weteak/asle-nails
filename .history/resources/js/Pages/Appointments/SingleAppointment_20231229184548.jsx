                ...
                <div className="s bg-white">
                    <div className="p-6">
                        <div className="flex items-center justify-between">
                            ...
                            <button onClick={() => callPhoneNumber(appointment.staff.phone_number)} className="flex bg-opacity-10 text-blue-600 items-center justify-center bg-blue-500 hover:bg-blue-600  font-semibold py-2 px-4 rounded-lg shadow">
