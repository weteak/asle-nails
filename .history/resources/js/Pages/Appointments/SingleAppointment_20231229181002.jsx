            ...
            <div className="container mx-auto  border-y py-2 my-3">
                <div className="s bg-white">
                    ...
                    <div className="px-6 py-4 ">
                        <button className="w-full mb-2 py-3.5 bg-blue-600 hover:bg-opacity-80 bg-opacity-90 text-white font-bold  px-4 rounded-lg">Edit Appointment</button>
                        <button className="w-full bg-red-600 border border-red-400 border-opacity-40 bg-opacity-10 hover:bg-opacity-20 text-red-600 font-bold py-3.5 px-4 rounded-lg">Cancel Appointment</button>
                    </div>
                </div>
            </div>
