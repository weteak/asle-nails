    ...
    return <div>
        ...
        <div className="m-4">
            ...
            <div className="w-full flex gap-2 relative border-y py-4 mt-2">
                <img className="w-32 my-auto object-cover rounded-full  h-32" src={returnImage(imagePathFormat(appointment.staff.profile_image))} alt={`${appointment.staff.profile_image}`} />
                <div className="absolute right-4 text-right">
                    <h2 className="text-black">{appointment.staff.name}</h2>
                    <span className="mt-2">+355{appointment.staff.phone_number}</span>
                    <span><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-telephone" viewBox="0 0 16 16">
