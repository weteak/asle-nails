...
export default function SingleAppointment({ appointment , user }) {
    ...
    function convertDateFormat(dateString) {
        ...
        formattedDate += ` ${date.toTimeString().split(' ')[0]} GMT${date.getTimezoneOffset() / -60 >= 0 ? '+' : ''}${Math.abs(date.getTimezoneOffset() / 60).toString().padStart(2, '0')}00 (Central European Standard Time)`;
