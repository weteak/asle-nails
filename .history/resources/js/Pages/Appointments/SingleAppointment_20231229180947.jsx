            ...
            <div className="container mx-auto  border-y py-2 my-3">
                <div className="s bg-white">
                    ...
                    <div className="px-6 py-4 ">
                        ...
                        <button className="w-full bg-red-600 border border-red-400 bg-opacity-10 hover:bg-opacity-20 text-red-600 font-bold py-3.5 px-4 rounded-lg">Cancel Appointment</button>
                    </div>
                </div>
            </div>
