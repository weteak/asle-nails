    ...
    return <div>
        ...
        <div className="mt-4">
            ...
            <div className=" px-7 text-left">
                ...
                <img className="w-32 absolute right-2 mx-8 my-auto object-cover rounded-full  h-32" src={returnImage(imagePathFormat(appointment.staff.profile_image))} alt={`${appointment.staff.profile_image}`} />
